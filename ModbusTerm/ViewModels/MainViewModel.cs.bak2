...
namespace ModbusTerm.ViewModels
{
    ...
    public class MainViewModel : ViewModelBase
    {
        ...
        // Property has been moved to line ~239
...
/// </summary>
public bool IsMultipleWriteFunction => CurrentRequest?.FunctionCode == 15 || CurrentRequest?.FunctionCode == 16;
...
public bool HasLastResponse => ResponseItems != null && ResponseItems.Count > 0;
        ...
        {
            bool isCoilWrite = CurrentRequest.FunctionCode == 5 || CurrentRequest.FunctionCode == 15;
        ...
        private void CalculateWriteQuantity()
        {
            if (CurrentRequest.IsWriteFunction && _writeDataInputs.Count > 0)
            {
                ...
                if (CurrentRequest.FunctionCode == 5 || CurrentRequest.FunctionCode == 15)
                {
                    CurrentRequest.Quantity = _writeDataInputs.Count;
                    return;
                }
                
                // For registers, calculate based on data types
                if (CurrentRequest.FunctionCode == 6 || CurrentRequest.FunctionCode == 16)
                {
                    ...
                    CurrentRequest.Quantity = totalRegisters;
                }
            }
        }
        ...
        private void UpdateWriteDataInputs()
        {
            ...
            {
                bool isCoilWrite = CurrentRequest.FunctionCode == 5 || CurrentRequest.FunctionCode == 15;
                bool isMultipleWrite = CurrentRequest.FunctionCode == 15 || CurrentRequest.FunctionCode == 16;
